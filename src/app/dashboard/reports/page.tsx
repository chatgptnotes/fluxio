    ...
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <div className="p-6">
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-3">
            <div className="bg-slate-800/80 border border-slate-700 rounded-lg p-4 h-full">
              <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-4 flex items-center">
                <span className="material-icons text-cyan-400 mr-2 text-sm">history</span>
                Recent Reports
              </h3>

              {reportHistory.length === 0 ? (
                <div className="text-center py-12">
                  <span className="material-icons text-slate-600 text-5xl mb-3">folder_open</span>
                  <p className="text-slate-500">No reports generated yet</p>
                  <p className="text-xs text-slate-600 mt-1">Generated reports will appear here</p>
                </div>
              ) : (
      ...
      <footer className="fixed bottom-0 left-0 right-0 border-t border-slate-700 bg-slate-800/90 backdrop-blur-sm px-6 py-2">
        <div className="flex items-center justify-between text-xs text-slate-500">
          ...
          <span>Version 1.3 | January 2025 | github.com/chatgptnotes/fluxio</span>
        </div>
      </footer>
    </div>
  )
